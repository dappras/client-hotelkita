      ...
      <div className="col-lg-6">
        ...
        <div className="row justify-content-center align-items-end h-100">
          ...
          >
            <img
              src="./logoLogin.svg"
              style={{ width: "7%", objectFit: "cover" }}
              alt=""
            />
            <a href="/" style={{ textDecoration: "none", color: "black" }}>
              <div className="mt-4" style={{ fontSize: 32, fontWeight: 500 }}>
                HotelKita
              </div>
            </a>
          </div>
      ...
      <div className="col-lg-6 elevation-2 bg-light p-5 container-login-register">
        <div className="row justify-content-center align-items-center h-100">
          <div className="col-lg-8">
            ...
            <div style={{ fontSize: 28, fontWeight: 500, marginBottom: 24 }}>
              Sign Up
            </div>
            ...
            <div className="d-flex justify-content-center mt-5">
              ...
              <span className="ml-2">
                <a
                  href="/login"
                  style={{ color: "#054574", textDecoration: "none" }}
                >
                  Login
                </a>
              </span>
