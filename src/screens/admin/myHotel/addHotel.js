    ...
    <div>
      ...
      <div className="content-wrapper row justify-content-center">
        ...
        <div className="col-lg-6 p-4">
          ...
          <div
            className="elevation-1 mt-5 p-4"
            ...
            <form>
              ...
              <div class="form-group">
                ...
                <textarea
                  class="form-control"
                  rows="4"
                  placeholder="Enter your hotel decription"
                  value={description}
              ...
              <div className="form-group">
                ...
                <input
                  type="text"
                  className="form-control"
                  placeholder="https://goo.gl/maps/HSZmVFQ8jhXo2y8M7"
                  value={urlMaps}
